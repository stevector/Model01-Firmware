...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_Escape,
   ...
   Key_UpArrow,  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   Key_RightShift, Key_LeftArrow, Key_DownArrow, Key_RightArrow,
   ShiftToLayer(FUNCTION)),
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_LEDEffectNext,
   ...
   ___,          Key_Mute,               Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_Backslash,    Key_Pipe,
   ___, ___, ___, ___,
   ___),
